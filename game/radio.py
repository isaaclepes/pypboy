...
#     def play(self):
#         if self.loaded and settings.SOUND_ENABLED:
#             self.paused = False
...
#         text = selectFont.render(game.Entity.name, True, (settings.bright), (0, 0, 0))
        
#         #text = selectFont.render(" -   Random Play Radio ", True, (105, 251, 187), (0, 0, 0))
        
#         self.blit(text, (75, 75))
#         text = basicFont.render("  'r' selects a random song ", True, (settings.bright), (0, 0, 0))
#         self.blit(text, (75, 100))
#         text = basicFont.render("  'p' to play   's' to stop ", True, (settings.bright), (0, 0, 0))
#         self.blit(text, (75, 120))
        
#         if self.filename:
#             text = selectFont.render(" %s " % metadata["ARTIST"] + ' - ' + metadata["TITLE"], True, (settings.bright), (0, 0, 0))
            
#             #text = selectFont.render(u" %s " % self.filename[self.filename.rfind(os.sep)+1:], True, (settings.bright), (0, 0, 0))
...
#     try:
#         files = load_files()
#         if files and settings.SOUND_ENABLED:
