    ...
    def redraw(self):
        ...
        for i in range(len(self.menu_array)):
            ...
            if i == self.selected:
                ...
                try:
                    number = settings.RobotoB[30].render(" %s " % self.menu_array[i][1], True, (0,0,0), (settings.bright))
                except:
                    number = ""
                ...
                try:
                    number = settings.RobotoB[30].render(" %s " % self.menu_array[i][1], True, (settings.bright), (0, 0, 0))
                except:
                    number = None
