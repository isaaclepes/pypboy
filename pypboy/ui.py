...
class Header(game.Entity):
	...
	def render(self, *args, **kwargs):
		...
		if new_date != self._date:
			...
			cndlength = 50
			pygame.draw.rect(self.image, (95, 255, 177), (config.WIDTH - 13 - 190 - 55,239,40,12)) #Condition bar
			pygame.draw.rect(self.image, (0, 70, 0), (config.WIDTH - 13 - 190 - 55 + 40,239,10,12))#Filler bar
